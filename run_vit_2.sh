...
OUTBASE="results/main4_spectral_vit_l_hetero/domainnet/screenot"
LOGBASE="results/main4_spectral_vit_l_hetero/domainnet/screenot/logs"
INIT="normal_a" 
...
LOGFILE="$LOGBASE/run_$(sanitize "$DATASET")_$(sanitize "$MODEL")_$(sanitize "$AGG")_${MODE}_r${ROUNDS}_c${CLIENTS}_f$(sanitize "$FRAC")_${TS}.log"
exec > "$LOGFILE" 2>&1
