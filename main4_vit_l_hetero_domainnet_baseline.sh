...
OUTBASE="results/main4_spectral_vit_l_hetero/domainnet/baselines4"
LOGBASE="results/main4_spectral_vit_l_hetero/domainnet/baselines4/logs"

mkdir -p "$OUTBASE" "$LOGBASE"

# CUDA_VISIBLE_DEVICES=0 nohup python3 main.py $COMMON_ARGS \
#     --aggregation flex \
#     --output_dir "$OUTBASE" \
#     > "$LOGBASE/flex_100c_75r_heter_r32_domainnet_vitl.log" 2>&1 &
# echo "flex PID: $!"
...
#     --aggregation florist \
#     --output_dir "$OUTBASE" \
#     > "$LOGBASE/florist_100c_75r_heter_r32_domainnet_vitl.log" 2>&1 &
# echo "florist PID: $!"
...
#     --aggregation flora \
#     --output_dir "$OUTBASE" \
#     > "$LOGBASE/flora_100c_75r_heter_r32_nicopp_domainnet.log" 2>&1 &
# echo "flora PID: $!"
...
CUDA_VISIBLE_DEVICES=5 nohup python3 main.py $COMMON_ARGS \
    --aggregation hetlora \
    --output_dir "$OUTBASE" \
    > "$LOGBASE/hetlora_100c_75r_heter_r32_domainnet_vitl.log" 2>&1 &
echo "hetlora PID: $!"
...
echo "All 1 methods launched in parallel!"