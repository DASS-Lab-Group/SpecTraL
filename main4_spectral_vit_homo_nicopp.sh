...
INIT_METHODS=(normal_a orthogonal_a svd_w0_a_vsqrt)  #zero normal_a trained_a svd_w0_a_vsqrt
GPUS=(3 4 5)

OUTBASE="results/main4_spectral_homo_vit_nicopp/gavishdonoho/vit_l/"
LOGBASE="results/main4_spectral_homo_vit_nicopp/gavishdonoho/vit_l/logs"
